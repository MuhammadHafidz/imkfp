...
<head>
    ...
    <!-- Title -->
    <title>Monggo Kemah - About Us</title>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="about-text mb-100">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus voluptatem similique, perspiciatis eveniet tempore nam cum libero, soluta nemo impedit rem delectus quasi repudiandae nostrum facilis corporis, molestiae quaerat dolorem!</p>
                    </div>
                </div>

                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail mb-100">
                        <img src="img/bg-img/pantai.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="our-milestones section-padding-100-0 bg-img bg-overlay bg-fixed" style="background-image: url(img/bg-img/bg-4.jpg);">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="section-heading text-center white">
                        ...
                        <p>MonggoCamp is everywhere you want to camp. Search, discover mountain, beach, forest, nature preserves & public sites for camping across Indonesia.</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="section-heading text-center white">
                        <p>Indonesia, dengan gugusan pulau-pulaunya, dengan bentangan lautnya, dan alamnya yang indah tentunya menjadi alasan  kamu yang ingin pengen berkemah untuk mengunjungi tempat tersebut satu persatu, terutama di jaman sekarang memerlukan informasi yang cepat dan tepat. Disini MonggoCamp memberikan solusi dalam masalah tersebut, nikmati fitur - fitur kami dan temukan tempat camping yang anda inginkan.</p>
                    </div>
                </div>
            </div>
        </div>
