...
<body>
                ...
                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail homepage mb-100">
                        ...
                        <div class="first-img wow fadeInUp" data-wow-delay="100ms">
                            <img src="img/bg-img/Gunung.jpg" alt="">
                        </div>
    ...
    <!-- ##### Pool Area Start ##### -->
    <section class="pool-area section-padding-100 bg-img bg-fixed" style="background-image: url(img/bg-img/Pantai.jpg);">
        <div class="container">
                ...
                <div class="col-12 col-lg-7">
                    <div class="pool-content text-center wow fadeInUp" data-wow-delay="300ms">
                        <div class="section-heading text-center white">
                            <div class="line-"></div>
                            <h2>For You</h2>
                            <p>Monggo Kemah tidak hanya sebuah website yang memberikan informasi tentang destinasi untuk Camping. Kami juga menyediakan penyewaan perlengkapan Camping </p>
                        </div>

                        <div class="row">
                            <div class="col-12 col-sm-4">
                                <div class="pool-feature">
                                    <!-- <img src="img/mentah logo/tenda.png" class="img-fluid" alt="" style="width: 60%; margin-top:-12px;"> -->
